...
6. **gitea-mcp live tool names/schemas** — S-GIT enumerated 53 names; `gitea-operations` + `lead-review-loop` authored in a later batch (per-tool JSON schemas still deferred).
